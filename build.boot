...
(task-options!
  pom {:project     'quamolit/quamolit-2048
       :version     +version+
       :description "Quamolit"
       :url         "https://github.com/Quamolit/quamolit-2048"
       :scm         {:url "https://github.com/Quamolit/quamolit-2048"}
...
(deftask dev []
  (comp
    ...
    (watch)
    (reload :on-jsload 'quamolit-2048.core/on-jsload)
    (cljs)
    (target)))
...
(deftask rsync []
  (fn [next-task]
    (fn [fileset]
      (sh "rsync" "-r" "target/" "tiye:repo/Quamolit/2048" "--exclude" "main.out" "--delete")
      (next-task fileset))))
